if (typeof kotlin === 'undefined') {
  throw new Error("Error loading module 'kotlinjs-simple-webapp'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'kotlinjs-simple-webapp'.");
}
this['kotlinjs-simple-webapp'] = function (_, Kotlin) {
  'use strict';
  ...
  CardBuilder.prototype.bind_0 = function (book, imageElement, titleElement, priceElement, descriptionElement, viewDetailsButtonElement) {
    ...
    viewDetailsButtonElement.addEventListener('click', CardBuilder$bind$lambda(book));
  };
  ...
  main([]);
  Kotlin.defineModule('kotlinjs-simple-webapp', _);
  return _;
}(typeof this['kotlinjs-simple-webapp'] === 'undefined' ? {} : this['kotlinjs-simple-webapp'], kotlin);
